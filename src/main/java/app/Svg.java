...
public class Svg {
    ...
    private static final String SVG_ARROW_STYLE = "stroke:#000000; marker-start: url(#beginArrow); marker-end: url(#endArrow);";
    private static final String SVG_TEXTWITHROTATION_TEMPLATE = "<text style=\"text-anchor: middle\" transform=\"translate(%d,%d) rotate(%d)\">%s</text>";
    private static final String SVG_TEXT_TEMPLATE = "<text style=\"text-anchor: middle\" x=\"%d\" y=\"%d\">%s</text>";
    ...
    public void addArrow(int x1, int y1, int x2, int y2)
    {
        ...
        svg.append(String.format(SVG_LINE_TEMPLATE,x1,y1,x2,y2,SVG_ARROW_STYLE));

    }

    public void addTextWithRotation(int x, int y, int rotation, String text)
    {
        svg.append(String.format(SVG_TEXTWITHROTATION_TEMPLATE, x,y,rotation,text));
